					...
					<tr>
						...
						<td>
							...
							<ul class="uk-list uk-list-line">
								...
								<li><a href="<?php echo base_url(); ?>sys_sn/view_lend">檢視借出記錄</a></li>
								<li><a href="<?php echo base_url(); ?>sys_sn/view_borrow">檢視借入記錄</a></li>
								<li><a href="<?php echo base_url(); ?>sys_sn/view_stock">檢視庫存記錄</a></li>
							</ul>
						</td>
						<td>
							<h3>RMA 管理</h3>
