...
<div id="main" class="uk-grid">
	...
	<div class="uk-width-8-10 form_margin">
		<h2 class="uk-text-primary">更新SPTS</h2>
		<hr>
		<?php $attributes = array('class' => 'uk-form', 'id' => 'form_update');
			  echo form_open('sys_sw/action_update_spts', $attributes);  ?>
			...
			<input type="button" value="取消/返回列表" class="uk-button" onclick="location.href='<?php echo base_url(); ?>sys_sw/create_spts';" />
